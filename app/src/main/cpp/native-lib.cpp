...
//Java_com_example_retrofitexample_MyPage_OpenCV_OpenCVActivity_ConvertRGBtoGray(JNIEnv *env,
//                                                                               jobject thiz,
//                                                                               jlong matAddrInput,
//                                                                               jlong matAddrResult) {
...
Java_com_example_retrofitexample_MyPage_OpenCV_OpenCVActivity_loadCascade(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_retrofitexample_MyPage_OpenCV_OpenCVActivity_detect(JNIEnv *env, jobject thiz,
    ...
    // cvtColor 함수를 사용하여 그레이스케일 영상으로 변환 한다.
    // 변환 된 그레이스케일 영상은 matResult 객체에 담겨 자바 코드에서 사용하게 된다.
