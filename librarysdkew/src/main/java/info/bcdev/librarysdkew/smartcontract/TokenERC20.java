...
public class TokenERC20 extends Contract {
    ...
    private static final String TAG = "TokenERC20";
    ...
    protected TokenERC20(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        ...
        android.util.Log.e(TAG, "TokenERC20: contractAddress: " + contractAddress);
        android.util.Log.e(TAG, "TokenERC20: web3j: " + web3j);
        android.util.Log.e(TAG, "TokenERC20: credentials: " + credentials);
        android.util.Log.e(TAG, "TokenERC20: gasPrice: " + gasPrice);
        android.util.Log.e(TAG, "TokenERC20: gasLimit: " + gasLimit);
    }
    ...
    protected TokenERC20(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        ...
        android.util.Log.e(TAG, "TokenERC20: ");
    }
    ...
    public RemoteCall<TransactionReceipt> transfer(String _to, BigInteger _value) {
        android.util.Log.e(TAG, "transfer: _to: " + _to);
        android.util.Log.e(TAG, "transfer: _value: " + _value);
        Function function = new Function(
                "transfer",
                Arrays.<Type>asList(new Address(_to),
                new Uint256(_value)),
                Collections.<TypeReference<?>>emptyList());
        android.util.Log.e(TAG, "transfer: function: " + function);
        return executeRemoteCallTransaction(function);
    }
    ...
    public static TokenERC20 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        android.util.Log.e(TAG, "load: 토큰 적재 ");
        android.util.Log.e(TAG, "load: contractAddress: " + contractAddress);
        android.util.Log.e(TAG, "load: web3j: " + web3j);
        android.util.Log.e(TAG, "load: credentials: " + credentials);
        android.util.Log.e(TAG, "load: gasPrice: " + gasPrice);
        android.util.Log.e(TAG, "load: gasLimit: " + gasLimit);
